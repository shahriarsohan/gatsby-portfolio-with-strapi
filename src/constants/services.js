...
export default [
  {
    ...
    text: `I will build your web application with some modern technologies like React and Angluar.My goal is to always build products that provide pixel-perfect, performant experiences.`,
  },
  {
    id: 2,
